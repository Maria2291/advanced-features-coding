...
/**
 * Same exericise as 7, only with Comparable Interface and Lombok
 */
...
public class FirstInListSorted {
    ...
    public static void main(String[] args) {
        ...
        employees.forEach(System.out::println); // it -> System.out.println(it), acelasi lucru cu un enhanced for
