...
/*
    Create multiple instances of the Employee class and add them to a list. Using iterative methods or
    ...
    Requirements:
        ...
        - in Main, create a List<Employee> with multiple instances (main)
            -- fie adaugati angajatii in lista folosind List.of
            -- fie creati lista goala si folositi metoda ".add(Employee obj)"
            -- fie creati lista goala si cititi repetitiv de la tastatura atributele necesare, construiti obiectul, il
            adaugati in clasa
        - find first Employee that is not null and has salary of at least 30000 (main)
            -- metoda iterativa
            -- metoda streamuri
            -- ambele metode returneaza un obiect de tipul Employee, pe care il verificam daca e null sau nu
            (Optional<Employee> ?)
        - if not found, throw exception or print a message (main)
    ...
    Output:  pot fi 3 situatii
        - un singur employee cu salariu > 30000
            -- daca sunt mai multi, fie maximul, cel cu salariul cel mai mare
            -- fie oricare, primul in ordinea citirii
        - un mesaj -> "Nu exista nici un angajat cu salariul specificat"
        - o exceptie -> "Nu exista nici un angajat cu salariul specificat"
*/
